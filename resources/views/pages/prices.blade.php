...
<div class="container">
    ...
    <div style="width:80%;border:1px solid white" class="card">
      <div class="dropdown">
              <button style="width:100%;border-radius:0px;font-family:new times roman;font-size:20px;background-color:white;border:1px solid gray;color:black;border-bottom:0px;" class="btn btn-primary dropdown-toggle" id="menu1" type="button" data-toggle="dropdown">End Of Tenancy Cleaning</button>
